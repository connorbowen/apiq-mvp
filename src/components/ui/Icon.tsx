...
// Common Icons used throughout your application
export const PlusIcon: React.FC<IconProps> = ({ size = 'md', className = '' }) => (
  <svg className={`${iconSizes[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ChevronDownIcon: React.FC<IconProps> = ({ size = 'md', className = '' }) => (
  <svg className={`${iconSizes[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const StopIcon: React.FC<IconProps> = ({ size = 'md', className = '' }) => (
  <svg className={`${iconSizes[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const LinkIcon: React.FC<IconProps> = ({ size = 'md', className = '' }) => (
  <svg className={`${iconSizes[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
  </svg>
);

export const ExclamationIcon: React.FC<IconProps> = ({ size = 'md', className = '' }) => (
  <svg className={`${iconSizes[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.732-.833-2.5 0L4.268 18.5c-.77.833.192 2.5 1.732 2.5z" />
  </svg>
);

export const InformationIcon: React.FC<IconProps> = ({ size = 'md', className = '' }) => (
  <svg className={`${iconSizes[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const EyeIcon: React.FC<IconProps> = ({ size = 'md', className = '' }) => (
  <svg className={`${iconSizes[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
...
export const EyeOffIcon: React.FC<IconProps> = ({ size = 'md', className = '' }) => (
  <svg className={`${iconSizes[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
