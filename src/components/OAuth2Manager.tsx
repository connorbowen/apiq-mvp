  ...
  const getProviderIcon = (providerName: string) => {
    switch (providerName.toLowerCase()) {
      ...
      case 'slack':
        return (
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
            <path d="M6.194 14.644c0 1.16-.943 2.107-2.107 2.107-1.164 0-2.107-.947-2.107-2.107 0-1.16.943-2.106 2.107-2.106 1.164 0 2.107.946 2.107 2.106zm5.74-2.107c-1.164 0-2.107.946-2.107 2.106 0 1.16.943 2.107 2.107 2.107 1.164 0 2.107-.947 2.107-2.107 0-1.16-.943-2.106-2.107-2.106zm5.74 0c-1.164 0-2.107.946-2.107 2.106 0 1.16.943 2.107 2.107 2.107 1.164 0 2.107-.947 2.107-2.107 0-1.16-.943-2.106-2.107-2.106zm-5.74-5.74c-1.164 0-2.107.943-2.107 2.107 0 1.164.943 2.107 2.107 2.107 1.164 0 2.107-.943 2.107-2.107 0-1.164-.943-2.107-2.107-2.107zm-5.74 0c-1.164 0-2.107.943-2.107 2.107 0 1.164.943 2.107 2.107 2.107 1.164 0 2.107-.943 2.107-2.107 0-1.164-.943-2.107-2.107-2.107z"/>
          </svg>
        );
      default:
        return (
    ...
    <div className="bg-white shadow rounded-lg p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <button
            onClick={() => initiateOAuth2Flow(connection.authConfig?.provider || 'github')}
          ...
          >
            {isAuthorizing ? (
              ...
              <>
                {getProviderIcon(connection.authConfig?.provider || 'github')}
